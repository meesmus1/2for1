					...
					<div class="header-row">
						...
						<nav class="primary-menu">
							...
							<ul class="one-page-menu menu-container" data-easing="easeInOutExpo" data-speed="1250" data-offset="60">
								...
								<li class="noborder menu-item"><div style="width: 2rem"></div></li>
								<li class="noborder menu-item"><a class="menu-link" href="./login.php"><div>Login</div></a></li>
								<li class="noborder menu-item"><a class="menu-link" href="./signup.php"><div>Signup</div></a></li>
					...
					<div class="container dark">
						<div class="row">
							<div class="col-lg-6 col-md-8 dotted-bg parallax" data-start="top: 0px; opacity: 1" data-400="top: 50px; opacity: 0.3">
								...
								<a href="./cart.php" data-easing="easeInOutExpo" data-speed="1250" class="button button-large button-rounded px-4 button-reveal d-inline-flex tright font-weight-semibold" data-animate="fadeInUp" data-delay="200">Bestel broodjes Provil</a>
