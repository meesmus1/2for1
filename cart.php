                                    ...
                                    <div class="emphasis-title" data-animate="fadeInUp">
                                        ...
                                        <form style="width: 23rem;">
                                            <div class="form-outline mb-4">
                                                ...
                                                <button class="btn button btn-sm" type="button" onclick="adjustQuantity('smos-kaas', 1)">+</button>
                                                <label class="form-label">Aantal: <span id="smos-kaas-quantity">0</span></label>
                                            </div>

                                            <div class="form-outline mb-4">
                                                <button class="btn button btn-sm" type="button" onclick="adjustQuantity('smos-ham', -1)">-</button>
                                                <label class="form-label">Smos Ham</label>
                                                <button class="btn button btn-sm" type="button" onclick="adjustQuantity('smos-ham', 1)">+</button>
                                                <label class="form-label">Aantal: <span id="smos-ham-quantity">0</span></label>
                                            </div>

                                            <div class="form-outline mb-4">
                                                <button class="btn button btn-sm" type="button" onclick="adjustQuantity('smos-martino', -1)">-</button>
                                                <label class="form-label">Smos Martino</label>
                                                <button class="btn button btn-sm" type="button" onclick="adjustQuantity('smos-martino', 1)">+</button>
                                                <label class="form-label">Aantal: <span id="smos-martino-quantity">0</span></label>
                                            </div>

                                            <div class="pt-1 mb-4">
                                                <button class="btn button btn-lg btn-block" type="button" onclick="bestellen()">Bestellen</button>
                                            </div>

                                            <p class="alert alert-danger" style="display: none;" id="isempty">niet alle velden zijn ingevuld.</p>

                                            <p>Betalen? <a class="" style="color: #FBAF32">Altijd contant bij ophalen!</a></p>
                                        </form>
